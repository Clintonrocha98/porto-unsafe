...
class PayrollsTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('entity')->label(__('validation.attributes.entity'))->searchable()->formatStateUsing(fn ($state): string => $state instanceof \App\Enums\MunicipalDepartment ? $state->getLabel() : $state),
